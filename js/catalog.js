;(function() {
    ...
    var catalogNav = catalogSection.querySelector('.catalog__nav');
    ...
    catalogNav.addEventListener('click', function(e) {
        ...
        if (item === null || item.classList.contains('is__active')) {
            return;
        } 

        e.preventDefault();
        var filterValue = item.getAttribute('data-filter');
        var previousBtnActive = catalogNav.querySelector('.catalog-nav__btn.is__active');

        previousBtnActive.classList.remove('is__active');
